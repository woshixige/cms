...
import static com.briup.cms.util.ResultCode.USER_TOKEN_FAILURE;
...
public class JwtUtil {  
     ...
     * jwt 密钥
     */
    private static final String SECRET = "product-source-666";
    ...
    public static boolean checkSign(String token) {
        try {
            ...
            throw new CustomException(USER_TOKEN_FAILURE);
        }
    }
}
